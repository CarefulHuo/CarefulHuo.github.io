    ...
    return function (t) {
        ...
        var r = n(0),
            ...
            u = function (t, e, n) {
                ...
                d && (n = e);
                for (c in n)(f = !p && w && void 0 !== w[c]) && s(g, c) || (l = f ? w[c] : n[c], g[c] =
                    d && "function" != typeof w[c] ? n[c] : m && f ? i(l, r) : y && w[c] == l ?
                    function (t) {
                    ...
                    }(l) : v && "function" == typeof l ? i(Function.call, l) : l, v && ((g.virtual ||
                        (g.virtual = {}))[c] = l, t & u.R && x && !x[c] && a(x, c, l)))
            };
        ...
        e.a = {
            ...
            computed: {
                lastLineClass: function () {
                    return "&nbsp" === this.lastLineContent ? "cursor" : "..." === this.lastLineContent ?
                        "loading" : void 0
                }
            },
            created: function () {
                this.supportingCommandList = f()(this.commandList).concat(f()(this.taskList))
            },
            mounted: function () {
                var t = this;
            ...
            methods: {
                ...
                handleCommand: function (t) {
                    ...
                    if (this.commandHistory.push(this.inputCommand), this.historyIndex = this.commandHistory
                        .length, void 0 !== this.prompt ? this.pushToList({
                            message: this.prompt + " " + this.inputCommand + " "
                        }) : this.pushToList({
                            message: "$ \\" + this.title + " " + this.inputCommand + " "
                        }), this.inputCommand) {
                        var n = this.inputCommand.split(" ");
                        "help" === n[0] ? this.printHelp(n[1]) : this.commandList[this.inputCommand] ?
                            this.commandList[this.inputCommand].messages.map(function (t) {
                                return e.pushToList(t)
                            }) : this.taskList[this.inputCommand.split(" ")[0]] ? this.handleRun(
                                this.inputCommand.split(" ")[0], this.inputCommand) : this.unknownCommandMessage ?
                            this.pushToList(this.unknownCommandMessage) : (this.pushToList({
                                level: "System",
                ...
                handlekeyEvent: function (t) {
                    switch (t.keyCode) {
                        case 38:
                            this.historyIndex = 0 === this.historyIndex ? 0 : this.historyIndex -
                                1, this.inputCommand = this.commandHistory[this.historyIndex];
                            break;
                        case 40:
                            this.historyIndex = this.historyIndex === this.commandHistory.length ?
                                this.commandHistory.length : this.historyIndex + 1, this.inputCommand =
                                this.commandHistory[this.historyIndex]
                    }
                },
                handleRun: function (t, e) {
                    var n = this;
                    return this.taskList[t] && this.taskList[t][t] ? (this.lastLineContent =
                        "...", this.taskList[t][t](this.pushToList, e).then(function (t) {
        ...
        t.exports = function (t, e, n, h, v, m, y) {
            ...
            var g, x, w, _ = function (t) {
                ...
                S = T || _(v),
                j = v ? L ? _("entries") : S : void 0,
                O = "Array" == e ? k.entries || T : T;
            if (O && (w = f(O.call(new t))) !== Object.prototype && w.next && (c(w, b, !0), r ||
                    "function" == typeof w[l] || a(w, l, d)), L && T && "values" !== T.name && (C = !
                    0, S = function () {
                        return T.call(this)
                    }), r && !y || !p && !C && k[l] || a(k, l, S), s[e] = S, s[b] = d, v)
                if (g = {
                        values: L ? S : _("values"),
                        keys: m ? S : _("keys"),
                        entries: j
        ...
        t.exports = function (t) {
            var e, n, s;
            return void 0 === t ? "Undefined" : null === t ? "Null" : "string" == typeof (n = a(e =
                    Object(t), o)) ? n : i ? r(e) : "Object" == (s = r(e)) && "function" == typeof e
                .callee ? "Arguments" : s
        }
    }, function (t, e, n) {
        var r = n(3),
        ...
        p && d || (p = function (t) {
                ...
                v.now(a(g, t, 1))
            } : h ? (o = new h, i = o.port2, o.port1.onmessage = x, r = a(i.postMessage, i, 1)) : f
            .addEventListener && "function" == typeof postMessage && !f.importScripts ? (r =
                function (t) {
                    f.postMessage(t + "", "*")
                }, f.addEventListener("message", x, !1)) : r = "onreadystatechange" in c("script") ?
            function (t) {
        ...
        var r = n(40);
        e.default = r.a, "undefined" != typeof window && window.Vue && window.Vue.component(
            "vue-terminal", r.a)
    }, function (t, e, n) {
        "use strict";
        function r(t) {
        ...
        var o = n(23),
            ...
            a = n(46),
            s = r,
            u = a(o.a, i.a, !1, s, "data-v-2e609d0e", null);
        e.a = u.exports
    }, function (t, e, n) {
        var r = n(42);
        ...
        t.exports = function (t, e, n, r, o, i) {
            ...
            e && (c.render = e.render, c.staticRenderFns = e.staticRenderFns, c._compiled = !0), n &&
                (c.functional = !0), o && (c._scopeId = o);
            var f;
            if (i ? (f = function (t) {
                    t = t || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent
                        .$vnode && this.parent.$vnode.ssrContext, t || "undefined" == typeof __VUE_SSR_CONTEXT__ ||
                        (t = __VUE_SSR_CONTEXT__), r && r.call(this, t), t && t._registeredComponents &&
        ...
        n(48), n(49), n(62), n(66), n(78), n(79), t.exports = n(2).Promise
        ...
        t.exports = function (t) {
            return function (e, n) {
                var i, a, s = String(o(e)),
                    u = r(n),
                    c = s.length;
                return u < 0 || u >= c ? t ? "" : void 0 : (i = s.charCodeAt(u), i < 55296 || i >
                    56319 || u + 1 === c || (a = s.charCodeAt(u + 1)) < 56320 || a > 57343 ?
                    t ? s.charAt(u) : i : t ? s.slice(u, u + 2) : a - 56320 + (i - 55296 <<
                        10) + 65536)
            }
        }
    }, function (t, e, n) {
        ...
        var r = n(3),
            ...
            u = function () {
                var t, e = n(18)("iframe"),
                    r = i.length;
                for (e.style.display = "none", n(32).appendChild(e), e.src = "javascript:", t = e.contentWindow
                    .document, t.open(), t.write("<script>document.F=Object<\/script>"), t.close(), u =
                    t.F; r--;) delete u.prototype[i[r]];
                return u()
            };
        t.exports = Object.create || function (t, e) {
            var n;
            return null !== t ? (s.prototype = r(t), n = new s, s.prototype = null, n[a] = t) : n =
                u(), void 0 === e ? n : o(n, e)
        }
    }, function (t, e, n) {
        var r = n(11),
        ...
        t.exports = Object.getPrototypeOf || function (t) {
            return t = o(t), r(t, i) ? t[i] : "function" == typeof t.constructor && t instanceof t.constructor ?
                t.constructor.prototype : t instanceof Object ? a : null
        }
    }, function (t, e, n) {
        n(63);
        for (var r = n(0), o = n(4), i = n(8), a = n(1)("toStringTag"), s =
        ...
        t.exports = n(25)(Array, "Array", function (t, e) {
            ...
            var t = this._t,
                e = this._k,
                n = this._i++;
            return !t || n >= t.length ? (this._t = void 0, o(1)) : "keys" == e ? o(0, n) :
        ...
        var r, o, i, a, s = n(16),
            ...
            P = !! function () {
                try {
                    ...
                    return (j || "function" == typeof PromiseRejectionEvent) && t.then(O) instanceof e &&
                        0 !== T.indexOf("6.6") && -1 === _.indexOf("Chrome/66")
                } catch (t) {}
            }(),
            M = function (t) {
                var e;
                    ...
                    g(function () {
                        for (var r = t._v, o = 1 == t._s, i = 0; n.length > i;) ! function (e) {
                            var n, i, a, s = o ? e.ok : e.fail,
                                ...
                                f = e.domain;
                            try {
                                s ? (o || (2 == t._h && I(t), t._h = 1), !0 === s ? n = r :
                                    (f && f.enter(), n = s(r), f && (f.exit(), a = !0)),
                                    n === e.promise ? c(L("Promise-chain cycle")) : (i =
                                        M(n)) ? i.call(n, u, c) : u(n)) : c(r)
                            } catch (t) {
                                f && !a && f.exit(), c(t)
                            }
                        }(n[i++]);
            ...
            N = function (t) {
                y.call(u, function () {
                    var e, n, r, o = t._v,
                        i = F(t);
                    if (i && (e = w(function () {
                            j ? C.emit("unhandledRejection", o, t) : (n = u.onunhandledrejection) ?
                                n({
                                    promise: t,
                                    reason: o
            ...
            A = function (t) {
                var e = this;
                e._d || (e._d = !0, e = e._w || e, e._v = t, e._s = 2, e._a || (e._a = e._c.slice()), R(
                    e, !0))
            },
            H = function (t) {
                var e, n = this;
        ...
        P || (S = function (t) {
            ...
            this._c = [], this._a = void 0, this._s = 0, this._d = !1, this._v = void 0, this._h =
                0, this._n = !1
        }, r.prototype = n(75)(S.prototype, {
            then: function (t, e) {
                var n = E(m(this, S));
                return n.ok = "function" != typeof t || t, n.fail = "function" ==
                    typeof e && e, n.domain = j ? C.domain : void 0, this._c.push(n),
                    this._a && this._a.push(n), this._s && R(this, !1), n.promise
            },
            catch: function (t) {
            ...
            var t = new r;
            this.promise = t, this.resolve = c(H, t, 1), this.reject = c(A, t, 1)
        }, x.f = E = function (t) {
            return t === S || t === a ? new i(t) : o(t)
        }), l(l.G + l.W + l.F * !P, {
            Promise: S
        }), n(21)(S, "Promise"), n(76)("Promise"), a = n(2).Promise, l(l.S + l.F * !P, "Promise", {
            reject: function (t) {
                var e = E(this);
            ...
            resolve: function (t) {
                return b(s && this === a ? S : this, t)
            }
        }), l(l.S + l.F * !(P && n(77)(function (t) {
            S.all(t).catch(O)
        })), "Promise", {
            all: function (t) {
                var e = this,
            ...
            e = t.exports = function (t, e, n, l, p) {
                ...
                if (i(y)) {
                    for (d = s(t.length); d > x; x++)
                        if ((m = e ? g(a(h = t[x])[0], h[1]) : g(t[x])) === c || m === f) return m
                } else
        ...
        var r = function () {
            ...
            o = r.regeneratorRuntime && Object.getOwnPropertyNames(r).indexOf("regeneratorRuntime") >=
            0,
            i = o && r.regeneratorRuntime;
        if (r.regeneratorRuntime = void 0, t.exports = n(82), o) r.regeneratorRuntime = i;
        else try {
        ...
        ! function (e) {
            ...
            function u(t) {
                function e(n, o, i, a) {
                    ...
                    if ("throw" !== s.type) {
                        var u = s.arg,
                            c = u.value;
                        return c && "object" == typeof c && g.call(c, "__await") ? Promise.resolve(c.__await)
                            .then(function (t) {
                                e("next", t, i, a)
                            }, function (t) {
                                e("throw", t, i, a)
                ...
                return function (i, a) {
                    ...
                    for (n.method = i, n.arg = a;;) {
                        ...
                        if ("next" === n.method) n.sent = n._sent = n.arg;
                            ...
                            if (o === k) throw o = j, n.arg;
                            n.dispatchException(n.arg)
                        } else "return" === n.method && n.abrupt("return", n.arg);
                        o = S;
                        var c = r(t, e, n);
                        if ("normal" === c.type) {
                            if (o = n.done ? j : T, c.arg === O) continue;
                            return {
                                value: c.arg,
                                done: n.done
                            }
            ...
            function f(t, e) {
                ...
                if (n === m) {
                    if (e.delegate = null, "throw" === e.method) {
                        if (t.iterator.return && (e.method = "return", e.arg = m, f(t, e), "throw" ===
                                e.method)) return O;
                ...
                var i = o.arg;
                return i ? i.done ? (e[t.resultName] = i.value, e.next = t.nextLoc, "return" !== e.method &&
                    (e.method = "next", e.arg = m), e.delegate = null, O) : i : (e.method = "throw",
                    e.arg = new TypeError("iterator result is not an object"), e.delegate = null, O
                )
            }
            function l(t) {
                var e = {
            ...
            if (C) return void(L && (t.exports = C));
            C = e.regeneratorRuntime = L ? t.exports : {}, C.wrap = n;
            ...
            var P = Object.getPrototypeOf,
                M = P && P(P(h([])));
            M && M !== y && g.call(M, w) && (E = M);
            var R = a.prototype = o.prototype = Object.create(E);
            i.prototype = R.constructor = a, a.constructor = i, a[b] = i.displayName =
                "GeneratorFunction", C.isGeneratorFunction = function (t) {
                    var e = "function" == typeof t && t.constructor;
                    return !!e && (e === i || "GeneratorFunction" === (e.displayName || e.name))
                }, C.mark = function (t) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(t, a) : (t.__proto__ = a, b in
                        t || (t[b] = "GeneratorFunction")), t.prototype = Object.create(R), t
                }, C.awrap = function (t) {
                    return {
                        __await: t
                    }
                ...
                }, s(R), R[b] = "Generator", R[w] = function () {
                    return this
                }, R.toString = function () {
                    ...
                    reset: function (t) {
                        if (this.prev = 0, this.next = 0, this.sent = this._sent = m, this.done = !
                            1, this.delegate = null, this.method = "next", this.arg = m, this.tryEntries
                            .forEach(p), !t)
                            for (var e in this) "t" === e.charAt(0) && g.call(this, e) && !isNaN(+e
                                .slice(1)) && (this[e] = m)
                    },
                    stop: function () {
                        this.done = !0;
                    ...
                    dispatchException: function (t) {
                        function e(e, r) {
                            return i.type = "throw", i.arg = t, n.next = e, r && (n.method = "next",
                                n.arg = m), !!r
                        }
        ...
        n(86), t.exports = n(2).Object.keys
    }, function (t, e, n) {
        var r = n(33),
            o = n(27);
        n(87)("keys", function () {
        ...
        var r = function () {
                var t = this,
                    ...
                    n = t._self._c || e;
                return n("div", {
                    staticClass: "vue-terminal",
                    on: {
                        click: t.handleFocus
                    }
                }, [t.showHeader ? n("div", {
                        staticClass: "terminal-header"
                    }, [n("h4", [t._v(t._s(t.title))]), t._v(" "), t._m(0)]) : t._e(), t._v(" "),
                    n("div", [n("div", {
                        ref: "terminalWindow",
                        staticClass: "terminal-window"
                    }, [t.greeting ? n("p", [t._v(t._s(t.greeting))]) : t._e(), t._v(
                        " "), t.defaultTaskCommandd ? n("p", [n("span", {
                        staticClass: "prompt"
                    }), n("span", {
                        staticClass: "cmd"
                    }, [t._v(t._s(t.defaultTaskCommandd))])]) : t._e(), t._v(
                        " "), t._l(t.messageList, function (e, r) {
                        return n("p", {
                            key: r
                        }, [n("span", [t._v(t._s(e.time))]), t._v(
                            " "), e.label ? n("span", {
                            class: e.type
                        }, [t._v(t._s(e.label))]) : t._e(), t._v(
                            " "), e.message.list ? n("span", {
                            staticClass: "cmd"
                        }, [n("pre", [t._v(t._s(e.message.text))]),
                            t._v(" "), n("ul", t._l(e.message
                                .list,
                                function (e, r) {
                                    return n("li", {
                                        key: r
                        ...
                        staticClass: "cmd"
                    }, [t._v(t._s(t.actionResult))])]) : t._e(), t._v(" "), n(
                        "p", {
                            ref: "terminalLastLine",
                            staticClass: "terminal-last-line"
                        }, ["&nbsp" === t.lastLineContent ? n("span", [void 0 !==
                                t.prompt ? n("span", {
                                    staticClass: "prompt"
                                }, [t._v(t._s(t.prompt))]) : n("span", {
                                    staticClass: "prompt"
                                }, [t._v("\\" + t._s(t.title))])]) : t._e(), t._v(
                                " "), n("span", [t._v(t._s(t.inputCommand))]),
                            t._v(" "), n("span", {
                                ...
                                on: {
                                    keyup: function (e) {
                                        return t.handleCommand(e)
                                    },
                                    input: function (e) {
                                        e.target.composing || (t.inputCommand =
                                            e.target.value)
                                    }
                                }
                            })])], 2)])])
            ...
            o = [function () {
                ...
                return n("ul", {
                    ...
                    staticClass: "shell-dots-red"
                }), t._v(" "), n("li", {
                    staticClass: "shell-dots-yellow"
                }), t._v(" "), n("li", {
                    staticClass: "shell-dots-green"
                })])
            }],
            i = {
                render: r,
